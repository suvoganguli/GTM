...
switch AircraftType
    case 'L1011_S2'
        ...
        Index.EOM  = find(strcmp(StateName,'gtm_design/Aircraft Model/L1011_S2/EOM/Integrator')==1);
        Index.Eng = ...
            find(strcmp(StateName,['gtm_design/Aircraft Model/L1011_S2/Engines/L1011_S2/Engine/', EngType,'/Tunable Lag/Integrator'])==1);
        Index.Ele = [...
            find(strcmp(StateName,'gtm_design/Aircraft Model/L1011_S2/Actuators/L1011_S2/LeftElevatorServo/Integrator')),...
            find(strcmp(StateName,'gtm_design/Aircraft Model/L1011_S2/Actuators/L1011_S2/RightElevatorServo/Integrator'))];
        Index.Ail = [...
            find(strcmp(StateName,'gtm_design/Aircraft Model/L1011_S2/Actuators/L1011_S2/LeftAileronServo/Integrator')),...
            find(strcmp(StateName,'gtm_design/Aircraft Model/L1011_S2/Actuators/L1011_S2/RightAileronServo/Integrator'))];
        Index.Rud =  ...
            find(strcmp(StateName,'gtm_design/Aircraft Model/L1011_S2/Actuators/L1011_S2/RudderServo/Integrator'));
