...
% $Id: example1.m 451 2008-03-05 14:04:50Z murch $
...
%% Working with New Copy of Open Loop Model

% Open block diagram
open_system('gtm_design_olp'); 

% Load variables
loadmws(SimVars,'gtm_design_olp');
...
set_param('gtm_design_olp/Input Generator/Doublet Generator','timeon','[2 12 7]'); 
set_param('gtm_design_olp/Input Generator/Doublet Generator','pulsewidth','[0.5 0.5 0.5]');
set_param('gtm_design_olp/Input Generator/Doublet Generator','amplitude',sprintf('[%f %f %f]',a(1),a(3),a(2)));
[tsim,xsim,ysim]=sim('gtm_design_olp',[0 max(tlin)]);
