...
%function [MWS] = Cal_params_T2(MWS)
%
% $Id: Cal_params_T2.m 2019 2009-09-03 20:32:23Z murch $
...
% Per Morelli email, 9/2/09, for sensor #10743
% Negated and swapped X/Y axes, negated Z gyro to change from Memsense axes to
% aircraft body-axes
MAG3TempComp.XGYRO  =  4.9745e-03;  % deg/s per deg C
MAG3TempComp.YGYRO  = -4.3213e-02;  % deg/s per deg C
MAG3TempComp.ZGYRO  =  4.2256e-02;  % deg/s per deg C
MAG3TempComp.XACCEL = -2.0895e-04;  % g per deg C
MAG3TempComp.YACCEL =  1.1745e-04;  % g per deg C
MAG3TempComp.ZACCEL = -1.1716e-05;  % g per deg C
